...
Preencha capa e cada slide.imagem copiando as URLs de candidatos.imagens_oficiais, na ordem em que vierem. Evite repetir a mesma imagem em slides diferentes — duas URLs do mesmo arquivo em tamanhos diferentes (…-scaled.jpg e …-2048x1365.jpg, ou /s1920/ e /w640-h360/) são a MESMA imagem, não duas. NÃO repita: o número de slides é o MENOR entre o que a matéria sustenta e quantas imagens DISTINTAS você recebeu. Com 4 imagens distintas, no máximo 4 slides — corte o fato mais fraco, não a variedade. Só abaixo de 3 imagens distintas a repetição é permitida, porque 3 é o mínimo do carrossel; aí repita a de melhor enquadramento. Nunca use a URL de uma página (.html) como imagem e nunca invente URLs. As imagens oficiais são aplicadas de forma determinística pelo fluxo — você não precisa pesquisar nem avaliar imagens.
